...
public class AdMemberDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//전체 게시글 수 조회
		int listCount  = new AdminMemoService().getListCountAdmin(userid);
		int mybklistCount = new MyBookService().getListCountAdmin(userid);
		int likebklistCount = new LikeBookService().getListCountAdmin(userid);
		int makebklistCount = new MakeBookService().getListCountAdmin(userid);
		...
		ArrayList<AdminMemo> memolist = new AdminMemoService().selectAll(userid, startRow, endRow);
		...
		if(m != null) {
			...
			request.setAttribute("mybklistCount", mybklistCount);
			request.setAttribute("likebklistCount", likebklistCount);
			request.setAttribute("makebklistCount", makebklistCount);
