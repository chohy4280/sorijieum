...
public class AdMemberSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//검색전체 게시글 수 조회
		int listCount  = new MemberService().getListCountMemberSearchAdmin(searchtype, keyword, gender, typenumber);
		...
		ArrayList<Member> list = new MemberService().selectMemberSearch(searchtype, keyword, gender, typenumber, startRow, endRow);
