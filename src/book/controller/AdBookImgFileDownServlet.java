...
/**
 * Servlet implementation class AdBookImgFileDownServlet
 */
@WebServlet("/bimgfdown.ad")
public class AdBookImgFileDownServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdBookImgFileDownServlet() {
        super();
