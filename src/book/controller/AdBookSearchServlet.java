...
public class AdBookSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// ----------------- 페이징 처리 추가 -----------------
				...
				//전체 게시글 수 조회
				int listCount  = new BookService().getListCountSelectBookSearch(searchtype, keyword, makestatus);
				...
				ArrayList<Book> list = new BookService().selectBookSearch(searchtype, keyword, makestatus, startRow, endRow);
