...
public class AdQuitMemberSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//전체 게시글 수 조회
		int listCount  = new QuitService().getSearchListCountAdmin(typenumber,userid,quittype);
		...
		ArrayList<Quit> list = new QuitService().selectQuitMemberSearch(typenumber, userid, quittype, startRow, endRow);
