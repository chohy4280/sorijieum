...
public class AdWishbookSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// ----------------- 페이징 처리 추가 -----------------
				...
				//전체 게시글 수 조회
				int listCount = new WishBookService().getListCountSearchAdmin(searchtype, keyword, wishstatus);
		...
		ArrayList<WishBook> list = new WishBookService().selectWishBookSearch(searchtype, keyword, wishstatus, startRow, endRow);
