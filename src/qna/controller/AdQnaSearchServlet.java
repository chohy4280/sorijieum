	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// ----------------- 페이징 처리 추가 -----------------
				...
				//현재 페이지 처리
						...
						//전체 게시글 수 조회
						int listCount  = new QnaService().getSearchListCountAdmin(searchtype, keyword, qnastatus, qnadate);
		...
		ArrayList<Qna> list = new QnaService().selectQnaSearch(searchtype, keyword, qnastatus, qnadate, startRow, endRow);
