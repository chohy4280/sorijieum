...
--USERTYPE 테이블 생성
DROP TABLE USERTYPE CASCADE CONSTRAINT;
...
--도서신청 데이터 입력
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user003', '아몬드', '손원평', '창비', '2017/03/31', '2019/01/12', 14, 'DONE', NULL, '2019/01/15', 'N');
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user005', '쇼코의 미소', '최은영', '문학동네', NULL, '2019/02/25', 12, 'DONE', NULL, '2019/03/03', 'N');
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user003', '쇼코의 미소', '최은영', NULL, NULL, '2019/03/02', 8, 'RJCT', '이미 신청된 도서입니다.', '2019/03/03', 'N');
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user005', '소년이 온다', '한강', NULL, NULL, '2019/09/02', 7, DEFAULT, NULL, NULL, 'N');
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user005', '검사내전', '김웅', NULL, NULL, '2019/09/08', 5, DEFAULT, NULL, NULL, 'N');
