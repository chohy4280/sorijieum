...
[파과]는 내가 살아남기 위해 누군가를 죽여야만 하는 이 지독하고 잔혹한 현실 속에서 어떤 기대도 소망도 없이, 오늘도 눈을 떴기 때문에, 그저 살아 있기 때문에, 기꺼이 살아내는 모든 것들에게 따뜻한 응원과 위로를 전한다.', '파과.jpg', '1162203625.jpg', '파과.pdf', '1162203625.pdf', '2019/10/7', 0, 'WAIT', DEFAULT);
...
철학이 현실 세계와 동떨어진 학문이라는 말을 강하게 부정하는 저자는 사람들이 철학을 쓸모없다고 여기는 이유가 철학과 비즈니스를 연결시켜서 생각하는 법을 모르기 때문이라고 진단한다. 오히려 그는 본질을 꿰뚫고 최적의 솔루션을 찾아내는 철학적 사고법이야말로 현대인들에게 가장 필요한 무기라고 말한다. 그가 비즈니스 현장에서 유용하게 사용하는 50가지 철학·사상을 담은 『철학은 어떻게 삶의 무기가 되는가』는 철학의 쓸모를 새롭게 조명하는 세상에서 가장 실용적인 철학 사용 설명서다.', '철학은 어떻게 삶의 무기가 되는가.jpg', '9791130620459.jpg', '철학은 어떻게 삶의 무기가 되는가.pdf', '9791130620459.pdf', '2019/09/12', 0, 'MAKE', DEFAULT);

INSERT INTO BOOK VALUES ('9788934972464', '사피엔스', '유발 하라리', '김영사', '2015/11/23', 640, '인간의 역사와 미래에 대한 가장 논쟁적인 대서사!
문명의 배를 타고 진화의 바다를 항해한 인류는 이제 어디로 나아갈 것인가! 왜 사피엔스 종만이 지구상에 살아남았나? 인간은 왜 역사상 가장 치명적인 동물이 되었는가? 인간의 유효기간은 언제까지인가? 역사, 사회, 생물, 종교, 등 학문의 경계를 넘나들며 인류 역사의 시간을 종횡무진 써내려간 문명의 항해기가 우리 눈앞에 펼쳐진다!', '사피엔스.jpg', '9788934972464.jpg', '사피엔스.pdf', '9788934972464.pdf', '2019/10/13', 0, 'WAIT', DEFAULT);

INSERT INTO BOOK VALUES ('8982816631', '자기 앞의 생', '에밀 아자르', '문학동네', '2003/05/06', 363, '자신에게 주어진 생을 완전히 만족하며 살아가는 사람이 몇이나 될까? 작가는 실제 나이보다 많은 나이를 살고 있는 열네 살 모모의 눈으로 이해하지 못할 세상을 바라본다. 모모의 눈에 비친 세상은 결코 꿈같이 아름다운 세상이 아니다. 인종 차별받는 아랍인, 감옥에 끌려갔다가 살아 돌아온 유태인, 성전환자 등... 세상 모든 사람들은 스승이라고 했듯이 모모의 눈에도 소설속 모든 이들이 인생의 굳은살을 단단하게 해주는 인생선배들이다. 작은 상처에도 아파하는 독자들이여, 온전히 삶을 보듬길 바란다면 지금 이 책 앞에 서라.', '자기 앞의 생.jpg', '8982816631.jpg', '자기 앞의 생.pdf', '8982816631.pdf', '2019/10/02', 0, 'MAKE', DEFAULT);
...
,'해리포터와_마법사의_돌2.jpg','8983925329.jpg','해리포터와_마법사의_돌2.pdf','8983925329.pdf','2019/05/11',3,'DONE', DEFAULT);
...
'해리포터와_비밀의_방1.jpg','8983925337.jpg','해리포터와_비밀의_방1.pdf','8983925337.pdf','2019/05/12',4,'DONE',DEFAULT);
...
'해리포터와_아즈카반의_죄수1.jpg','8983925353.jpg','해리포터와_아즈카반의_죄수1.pdf','8983925353.pdf','2019/05/14',2,'DONE',DEFAULT);
...
론네 식구들에게 보호받으며 방학을 보낸 해리가 호그와트로 돌아가자, 시리우스 블랙이 침입한 흔적이 학교 곳곳에서 발견된다. 
그가 부모님을 배신하여 죽음에 이르게 했다는 것을 알게 된 해리는 단짝 친구들과 함께 시리우스 블랙을 찾아나선다.',
'해리포터와_아즈카반의_죄수2.jpg','8983925361.jpg','해리포터와_아즈카반의_죄수2.pdf','8983925361.pdf','2019/05/15',2,'DONE',DEFAULT);
...
'해리포터와_불의_잔1.jpg','9788983925374.jpg','해리포터와_불의_잔1.pdf','9788983925374.pdf','2019/05/16',2,'DONE',DEFAULT);
...
다시 호그와트로 돌아온다.',
'해리포터와_불의_잔2','8983925388.jpg','해리포터와_불의_잔2.pdf','8983925388.pdf','2019/05/17',2,'DONE',DEFAULT);
...
마지막 시합 날 함께 우승컵을 잡은 케드릭과 해리는 볼드모트가 있는 곳으로 소환된다. 
케드릭은 볼드모트에게 살해당하지만, 해리는 부모 영혼의 도움으로 그 자리를 간신히 탈출하여 다시 호그와트로 돌아온다.',
'해리포터와_불의_잔3.jpg','8983925396.jpg','해리포터와_불의_잔3.pdf','8983925396.pdf','2019/05/18',2,'DONE',DEFAULT);
...
마지막 시합 날 함께 우승컵을 잡은 케드릭과 해리는 볼드모트가 있는 곳으로 소환된다. 
케드릭은 볼드모트에게 살해당하지만, 해리는 부모 영혼의 도움으로 그 자리를 간신히 탈출하여 다시 호그와트로 돌아온다.',
'해리포터와_불의_잔4.jpg','9788983925404.jpg','해리포터와_불의_잔4.pdf','9788983925404.pdf','2019/05/19',2,'DONE',DEFAULT);
...
'해리포터와_불사조_기사단1.jpg','8983925418.jpg','해리포터와_불사조_기사단1.pdf','8983925418.pdf','2019/05/20',1,'DONE',DEFAULT);
...
이 일로 해리가 퇴학당할 위기에 처하자 덤블도어는 대신 죄를 뒤집어쓰고 마법부의 감시를 피해 몸을 감춘다. 
한편 해리는 대부 시리우스가 볼드모트에 의해 마법부의 미스터리 부서로 끌려가는 꿈을 꾸고 친구들과 구출 작전을 개시한다.',
'해리포터와_불사조_기사단2.jpg','8983925426.jpg','해리포터와_불사조_기사단2.pdf','8983925426.pdf','2019/05/21',1,'DONE',DEFAULT);
...
이 일로 해리가 퇴학당할 위기에 처하자 덤블도어는 대신 죄를 뒤집어쓰고 마법부의 감시를 피해 몸을 감춘다. 
한편 해리는 대부 시리우스가 볼드모트에 의해 마법부의 미스터리 부서로 끌려가는 꿈을 꾸고 친구들과 구출 작전을 개시한다.',
'해리포터와_불사조_기사단3.jpg','8983925434.jpg','해리포터와_불사조_기사단3.pdf','8983925434.pdf','2019/05/22',21,'DONE',DEFAULT);
...
해리는 론, 헤르미온느와 더불어 ‘덤블도어의 군대’라는 모임을 조직 몰래 마법을 익힌다.
 이 일로 해리가 퇴학당할 위기에 처하자 덤블도어는 대신 죄를 뒤집어쓰고 마법부의 감시를 피해 몸을 감춘다. 
한편 해리는 대부 시리우스가 볼드모트에 의해 마법부의 미스터리 부서로 끌려가는 꿈을 꾸고 친구들과 구출 작전을 개시한다.',
'해리포터와_불사조_기사단4.jpg','8983925442.jpg','해리포터와_불사조_기사단4.pdf','8983925442.pdf','2019/05/23',20,'DONE',DEFAULT);
...
'해리포터와_혼혈왕자1.jpg','8983925469.jpg','해리포터와_혼혈왕자1.pdf','8983925469.pdf','2019/05/24',19,'DONE',DEFAULT);
...
두 사람은 호크룩스를 찾기 위해 볼드모트가 어린 시절 들렀던 동굴을 찾지만 별 소득을 얻지 못한다. 
지친 몸으로 학교에 돌아온 해리는 잠입한 볼드모트의 추종자들과 맞닥뜨리고, 뼈아픈 상실을 경험하게 된다.',
'해리포터와_혼혈왕자2.jpg','8983925477.jpg','해리포터와_혼혈왕자2.pdf','8983925477.pdf','2019/05/25',17,'DONE',DEFAULT);
...
'해리포터와_혼혈왕자3.jpg','8983925485.jpg','해리포터와_혼혈왕자3.pdf','8983925485.pdf','2019/05/26',2,'DONE',DEFAULT);
...
볼드모트가 어린 시절 들렀던 동굴을 찾지만 별 소득을 얻지 못한다. 지친 몸으로 학교에 돌아온 해리는 잠입한 
볼드모트의 추종자들과 맞닥뜨리고, 뼈아픈 상실을 경험하게 된다.',
'해리포터와_혼혈왕자4.jpg','8983925493.jpg','해리포터와_혼혈왕자4.pdf','8983925493.pdf','2019/05/27',13,'DONE',DEFAULT);
...
'해리포터와_죽음의_성물1.jpg','8983925507.jpg','해리포터와_죽음의_성물1.pdf','8983925507.pdf','2019/05/28',10,'DONE',DEFAULT);
...
마지막 남은 죽음의 성물이 어디 있는지, 볼드모트와 대적할 방도는 무엇인지도 모른 채, 마지막 남은 호크룩스를 파괴하고 
볼드모트와의 결전을 치르기 위해 해리와 친구들은 죽음을 먹는 자들이 장악하고 있는 호그와트로 잠입한다.',
'해리포터와_죽음의_성물2jpg','8983925655.jpg','해리포터와_죽음의_성물2.pdf','8983925655.pdf','2019/05/29',1,'DONE',DEFAULT);
...
마지막 남은 죽음의 성물이 어디 있는지, 볼드모트와 대적할 방도는 무엇인지도 모른 채, 마지막 남은 호크룩스를 파괴하고 
볼드모트와의 결전을 치르기 위해 해리와 친구들은 죽음을 먹는 자들이 장악하고 있는 호그와트로 잠입한다.',
'해리포터와_죽음의_성물3.jpg','8983925523.jpg','해리포터와_죽음의_성물3.pdf','8983925523.pdf','2019/06/01',1,'DONE',DEFAULT);
...
볼드모트와의 결전을 치르기 위해 해리와 친구들은 죽음을 먹는 자들이 장악하고 있는 호그와트로 잠입한다.',
'해리포터와_죽음의_성물4.jpg','8983925531.jpg','해리포터와_죽음의_성물4.pdf','8983925531.pdf','2019/06/02',5,'DONE',DEFAULT);
...
'희랍어의_시간.jpg','8954616518.jpg','희랍어의_시간.pdf','8954616518.pdf','2019/09/01',60,'DONE',DEFAULT);
...
'내_여자의_열매.jpg','8932034826.jpg','희랍어의_시간.pdf','8932034826.pdf','2019/09/02',73,'DONE',DEFAULT);
...
'채식주의자.jpg','8936433598.jpg','채식주의자.pdf','8936433598.pdf','2019/09/03',69,'DONE',DEFAULT);
...
'검은사슴.jpg','8982811338.jpg','검은사슴.pdf','8982811338.pdf','2019/09/04',80,'DONE', DEFAULT);
...
'그대의_차가운_손.jpg','8932013047.jpg','그대의_차가운_손.pdf','8932013047.pdf','2019/09/05',76,'DONE',DEFAULT);

INSERT INTO BOOK VALUES ('9788950980726', '타인의 시선을 의식해 힘든 나에게', '글배우', '21세기북스', '2019/04/19', 184, '생각이 너무 많아 괴롭거나, 감정 기복이 심하거나, 작은 말에도 상처받는 이유는 우리가 알게 모르게 타인의 시선을 의식하며 살고 있기 때문이다. 수년 간 많은 이들의 고민을 직접 상담해오며 요즘 사람들이 가장 걱정하는 문제에 대해 같이 공감하고 이야기를 나눈 저자는 이들에게 실질적인 도움을 줄 수 있는 방법을 모아 이 책에 담았다.', '타인의 시선을 의식해 힘든 나에게.jpg', '9788950980726.jpg', '타인의 시선을 의식해 힘든 나에게.pdf', '9788950980726.pdf', '2019/10/03', 0, 'MAKE', DEFAULT);
...
경제 위기는 피할 수 없는 우리의 미래다. 이 책은 독자들이 부의 지각변동 속에서 무너지지 않고 기회를 만드는 결정적인 계기가 될 것이다.', '2020 부의 지각변동.jpg', '9788950981983.jpg', '2020 부의 지각변동1.pdf', '9788950981983.pdf', '2019/10/15', 0, 'WAIT', DEFAULT);
INSERT INTO BOOK VALUES ('9791188248674', '90년생이 온다', '임홍택', '웨일북', '2018/11/16', 336, '“이해하기 어렵다면 제대로 관찰하라!”
언어생활부터 소비성향, 가치관까지
세상을 주도하는 90년생을 파헤치다', '90년생이 온다.jpg', '9791188248674.jpg', '90년생이 온다.pdf', '9791188248674.pdf', '2019/10/15', 0, 'MAKE', DEFAULT);
...
저자는 지진, 날씨, 바다, 산 등 자연에서부터 온천, 나침반, 경위도, 대리석, 공룡 이야기까지 너무 재밌어서 잠 못 드는 22가지 지구 과학 이야기를 소개합니다.', '너무 재밌어서 잠못드는 지구의 과학.jpg', '9788965134947.jpg', '너무 재밌어서 잠못드는 지구의 과학.pdf', '9788965134947.pdf', '2019/10/15', 0, 'WAIT', DEFAULT);
...
스웨덴의 시골 마을에서 태어났지만 백 년이 넘는 세월을 살면서 본의 아니게 세계사의 주요 사건에 끼어들게 된 주인공 알란 칼손. 백 살 생일날 양로원 창문을 넘어 도망쳤던 알란이 이번에는 백 한 살 생일날 열기구를 탔다가 조난당하며 새로운 모험을 시작한다. 『핵을 들고 도망친 101세 노인』은 요나손의 통산 네 번째 소설이다.', '핵을 들고 도망친 101세 노인.jpg', '9788932919874.jpg', '핵을 들고 도망친 101세 노인.pdf', '9788932919874.pdf', '2019/10/15', 0, 'MAKE', DEFAULT);
...
--관심도서 데이터 입력
INSERT INTO LIKEBOOK VALUES ('user003', '9788983925404');
INSERT INTO LIKEBOOK VALUES ('user003', '8983925418');
INSERT INTO LIKEBOOK VALUES ('user003', '8983925426');
INSERT INTO LIKEBOOK VALUES ('user003', '8983925434');
INSERT INTO LIKEBOOK VALUES ('user003', '8983925442');
INSERT INTO LIKEBOOK VALUES ('user005', '8983925442');
INSERT INTO LIKEBOOK VALUES ('user005', '8983925469');
INSERT INTO LIKEBOOK VALUES ('user005', '8983925353');
INSERT INTO LIKEBOOK VALUES ('user005', '8983925310');
INSERT INTO LIKEBOOK VALUES ('user005', '8983925353');
...
INSERT INTO MAKEBOOK VALUES ('user001', '8937473135', DEFAULT);
...
INSERT INTO MAKEBOOK VALUES ('user002', '8937473135', DEFAULT);
...
--도서신청 데이터 입력
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user003', '아몬드', '손원평', '창비', '2017/03/31', '2019/01/12', 14, 'DONE', NULL, '2019/01/15', 'N', 'admin00', 'A');
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user005', '쇼코의 미소', '최은영', '문학동네', NULL, '2019/02/25', 12, 'DONE', NULL, '2019/03/03', 'N', 'admin01', 'A');
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user003', '쇼코의 미소', '최은영', NULL, NULL, '2019/03/02', 8, 'RJCT', '이미 신청된 도서입니다.', '2019/03/03', 'N' , 'admin00', 'A');
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user005', '소년이 온다', '한강', NULL, NULL, '2019/09/02', 7, DEFAULT, NULL, NULL, 'N', NULL, NULL);
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user005', '검사내전', '김웅', NULL, NULL, '2019/09/08', 5, DEFAULT, NULL, NULL, 'N', NULL, NULL);
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user001', '여행의 이유', '김영하', NULL, NULL, '2019/09/08', 4, DEFAULT, NULL, NULL, 'N', NULL, NULL);
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user002', '해리포터 시리즈', '제이케이롤링', NULL, NULL, '2019/09/09', 9, DEFAULT, NULL, NULL, 'N', NULL, NULL);
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user002', '아몬드', '손원평', NULL, NULL, '2019/09/09', 8, DEFAULT, NULL, NULL, 'N', NULL, NULL);
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user001', '너무 재밌어서 잠 못 드는 심리학 사전', '스벤야 아이젠브라운', NULL, NULL, '2019/09/10', 3, DEFAULT, NULL, NULL, 'N', NULL, NULL);
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user004', '박막례, 이대로 죽을 순 없다', '박막례, 김유라', '위즈덤 하우스', NULL, '2019/09/11', 11, DEFAULT, NULL, NULL, 'N', NULL, NULL);
INSERT INTO WISHBOOK VALUES (SEQ_WISHNO.NEXTVAL, 'user003', '개미', '베르나르 베르베르', NULL, NULL, '2019/09/11', 7, DEFAULT, NULL, NULL, 'N', NULL, NULL);

--qna 데이터 입력
INSERT INTO QNA VALUES (SEQ_QNANO.NEXTVAL, '한자 작성은 어떻게 하면되나요', 'user002', '도서 중간중간 나오는 한자는 어떻게 작성하면 되나요?', '2019/09/23', 21, 'Y', NULL, NULL, 'N', 'A');
INSERT INTO QNA VALUES (SEQ_QNANO.NEXTVAL, '제작한 도서는 어떻게 이용할수 있나요??', 'user002', '제작자는 따로 이용못하는 건가요?', '2019/09/24', 10, 'Y', NULL, NULL, 'N', NULL);
INSERT INTO QNA VALUES (SEQ_QNANO.NEXTVAL, '도서 이어듣기는 어떻게 하는건가요?', 'user003', '기존에 읽었던 도서를 이어읽고 싶습니다. 어떻게 해야하나요?', '2019/09/25', 8, 'Y', NULL, NULL, 'N', 'A');
INSERT INTO QNA VALUES (SEQ_QNANO.NEXTVAL, '제작할 도서가 없습니다', 'user001', '도서 제작 페이지에 제작할 도서가 없다면 어떻게 해야되나요?', '2019/09/26', 14, 'Y', NULL, NULL, 'N', 'A');
INSERT INTO QNA VALUES (SEQ_QNANO.NEXTVAL, '표 작성은 어떻게 하는지 궁금합니다.', 'user001', '도서 내용에 표가 있다면 어떻게 작성하면 되나요?', '2019/09/27', 3, 'N', NULL, NULL, 'N', 'A');
...
INSERT INTO QUIT VALUES('quituser03','G','사이트를 이용하지 않습니다.','2019-08-');
...
-- 도서제작확인 데이터 추가
INSERT INTO BOOKMAKINGCHECK VALUES ('8937473097', NULL, DEFAULT, NULL, 1, NULL, DEFAULT);
INSERT INTO BOOKMAKINGCHECK VALUES ('8937473097', NULL, DEFAULT, NULL, 11, NULL, DEFAULT);
INSERT INTO BOOKMAKINGCHECK VALUES ('8937473097', NULL, DEFAULT, NULL, 21, NULL, DEFAULT);
