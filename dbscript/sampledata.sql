...
--회원 구분 테이블 데이터 입력
INSERT INTO USERTYPE VALUES(1,'이용대기자');
INSERT INTO USERTYPE VALUES(2,'이용자');
INSERT INTO USERTYPE VALUES(3,'제작자');
INSERT INTO USERTYPE VALUES(4,'부관리자');
INSERT INTO USERTYPE VALUES(5,'대표관리자');

--회원 테이블 데이터 입력
INSERT INTO MEMBER VALUES(
'admin00',5,'최민영','adpass00','010-0000-0000','admin@gmail.com','F','1993-06-14',DEFAULT,NULL,NULL,'N');

INSERT INTO MEMBER VALUES(
'admin01',4,'이유진','admin01','010-0101-0101','admin01@gmail.com','F','1993-03-06',DEFAULT,NULL,NULL,'N');

INSERT INTO MEMBER VALUES(
'admin02',4,'이은수','admin02','010-0202-0202','admin02@gmail.com','F','1999-01-17',DEFAULT,NULL,NULL,'N');

INSERT INTO MEMBER VALUES(
'user001',3,'박예은','pass001','010-1234-1234','user001@naver.com','F','1995-12-04',DEFAULT,NULL,NULL,'N');

INSERT INTO MEMBER VALUES(
'user002',3,'조하영','pass002','010-2345-2345','user002@naver.com','F','1993-04-28',DEFAULT,NULL,NULL,'N');

INSERT INTO MEMBER VALUES(
'user003',2,'이아무개','pass003','010-3456-3456','user003@daum.net','M','1997-08-04',default,'등록증.jpg','201909211234.jpg','N');

INSERT INTO MEMBER VALUES(
'user004',1,'김첨지','pass004','010-4444-3333','user004@naver.com','M','1978-05-17',DEFAULT,NULL,NULL,'N');

INSERT INTO MEMBER VALUES(
'user005',2,'박공주','pass005','010-5555-6666','user005@gmail.com','F','1987-04-21',DEFAULT,'장애인등록증.jpg','201909272341.jpg','N');

INSERT INTO MEMBER VALUES(
'user006',1,'왕건','pass006','010-6666-3444','user006@daum.net','M','1955-05-06',DEFAULT,NULL,NULL,'N');

INSERT INTO MEMBER VALUES(
'user007',3,'김철수','pass007','010-8766-9877','user007@gmail.com','M','1985-11-19',default,null,null,'N');

--관리자 메모 데이터 생성
INSERT INTO ADMINMEMO
VALUES('user001','admin00','제한 시간 안에 할당된 도서페이지를 완성 하지 못했음',SYSDATE);

INSERT INTO ADMINMEMO
VALUES('user005','admin01','사이트 이용중 도서재생에서 강제종료 된다고 전화로 항의함',SYSDATE);
...
--도서제작 데이터 입력
INSERT INTO BOOKMAKING VALUES (8954655971, '2019-04-29', NULL, '여행의 이유_김영하.pdf', NULL, NULL, 43);
INSERT INTO BOOKMAKING VALUES (8954641636, '2019-03-03', NULL, '쇼코의 미소_최은영.pdf', NULL, NULL, 56);
INSERT INTO BOOKMAKING VALUES (8936434268, '2019-01-15', '2019-01-31', '아몬드_손원평.pdf', '아몬드_손평원.txt', '201901312208.txt', 264);
INSERT INTO BOOKMAKING VALUES (8937473135, SYSDATE, NULL, '82년생 김지영_조남주.pdf', NULL, NULL, DEFAULT);
INSERT INTO BOOKMAKING VALUES (8937473097, SYSDATE, NULL, '보건교사 안은영_정세랑.pdf', NULL, NULL, DEFAULT);
INSERT INTO BOOKMAKING VALUES (8982814477, SYSDATE, NULL, '연금술사_파울로 코엘료.pdf', NULL, NULL, DEFAULT);

--도서신청 데이터 입력
INSERT INTO WISHBOOK VALUES (1, 'user003', '아몬드', '손원평', '창비', '2017/03/31', '2019/01/12', 7, 14, 'DONE', NULL, '2019/01/15');
INSERT INTO WISHBOOK VALUES (2, 'user005', '쇼코의 미소', '최은영', '문학동네', NULL, '2019/02/25', 7, 12, 'DONE', NULL, '2019/03/03');
INSERT INTO WISHBOOK VALUES (3, 'user003', '쇼코의 미소', '최은영', NULL, NULL, '2019/03/02', 2, 8, 'RJCT', '이미 신청된 도서입니다.', '2019/03/03');
INSERT INTO WISHBOOK VALUES (4, 'user005', '소년이 온다', '한강', NULL, NULL, '2019/09/02', 4, 7, DEFAULT, NULL, NULL);
INSERT INTO WISHBOOK VALUES (5, 'user005', '검사내전', '김웅', NULL, NULL, '2019/09/08',	3, 5, DEFAULT, NULL, NULL);

--qna 데이터 입력
INSERT INTO QNA VALUES (5, '표 작성은 어떻게 하는지 궁금합니다.', 'user001', '도서 내용에 표가 있다면 어떻게 작성하면 되나요?', '2019/09/27', 3, 'N', NULL, NULL, 'N');

INSERT INTO QNA VALUES (4, '제작할 도서가 없습니다', 'user001', '도서 제작 페이지에 제작할 도서가 없다면 어떻게 해야되나요?', '2019/09/26', 14, 'Y', NULL, NULL, 'N');

INSERT INTO QNA VALUES (3, '도서 이어듣기는 어떻게 하는건가요?', 'user003', '기존에 읽었던 도서를 이어읽고 싶습니다. 어떻게 해야하나요?', '2019/09/25', 8, 'Y', NULL, NULL, 'N');

INSERT INTO QNA VALUES (2, '제작한 도서는 어떻게 이용할수 있나요??', 'user002', '제작자는 따로 이용못하는 건가요?', '2019/09/24', 10, 'Y', NULL, NULL, 'N');

INSERT INTO QNA VALUES (1, '한자 작성은 어떻게 하면되나요', 'user002', '도서 중간중간 나오는 한자는 어떻게 작성하면 되나요?', '2019/09/23', 21, 'Y', NULL, NULL, 'N');

--qna 답변 데이터 입력
INSERT INTO QNACOMMENT VALUES (4, 'admin00', '도서 제작에 제작할 도서가 없는것은 신청된 도서가 다 제작되었기 때문입니다. 며칠후 다시 확인부탁드립니다.', '2019/09/27', null, null);
INSERT INTO QNACOMMENT VALUES (3, 'admin01', '도서 듣기 메뉴 상단의 종료 버튼을 누르면 자동으로 이어듣기 북마크가 생성됩니다.', '2019/09/26', null, null);
INSERT INTO QNACOMMENT VALUES (2, 'admin01', '네, 죄송합니다. 제작자는 도서 듣기를 이용할 수 없습니다. 이 사이트는 시각장애인들을 위한 사이트이므로 시각장애인인분들만 도서 듣기를 이용할 수 있습니다.', '2019/09/25', null, null);
INSERT INTO QNACOMMENT VALUES (1, 'admin02', '네이버 사전에 한자를 그려서 확인할수 있습니다.', '2019/09/24', null, null);


--FAQ 데이터 입력
INSERT INTO FAQ
VALUES(1,'admin01','도서제작 하려면 어떻게 해야하나요?','도서제작 메뉴를 눌러 제작해야할 도서 목록에서 제작하실 도서를 클릭하신 후, 도서정보 하단의 제작하기를 누르시고 제작방법을 반드시 숙지하신 후 도서입력 및 편집을 하시면 됩니다.','2019-09-27',null,null);

SET DEFINE OFF;
INSERT INTO FAQ
VALUES(2,'admin01','도서제작시 오류가 났는데 어떻게 해야하나요?','크롬 브라우저를 사용하시거나, 인터넷 캐쉬를 삭제하여 보신 후에도 개선되지 않는다면 Q&A에 오류화면을 등록하여주시면 빠른 답변드리겠습니다.','2019-09-27',null,null);

INSERT INTO FAQ
VALUES(3,'admin01','봉사시간은 지급가능한가요?','소리지음은 제작자 분들의 재능기부로 이루어지는 시각장애인용 도서제작 사이트입니다. 봉사시간이 필요하신 분들께서는 관련사이트 안내로 봉사사이트 링크를 들어가시기 바랍니다.','2019-09-27',null,null);

INSERT INTO FAQ 
VALUES(4,'admin01','제작된 도서는 이용자들이 어떻게 이용하나요?','도서검색 메뉴에서 이용자분들께서 읽고싶은 도서를 검색하신 후,음성 안내에 따라 도서출력기능을 이용하실 수 있습니다.','2019-09-27',null,null);

INSERT INTO FAQ
VALUES(5,'admin01','도서제작 과정이 궁금해요.','도서제작 과정은 먼저 이용자분들이 원하시는 도서를 신청받고, 도서 정보가 등록되면 제작자분들의 참여로 최대한 빠르게 도서를 제작, 검토 하여 이용자분들이 이용하실 수 있도록 만들어집니다!','2019-09-27',null,null);
...
INSERT INTO NOTICE VALUES (1,'홈페이지 서버 오류에 대한 안내','admin02','안녕하세요, 소리지음 입니다.
...
--회원탈퇴 데이터 입력
INSERT INTO MEMBER VALUES(
'quituser01',3,'김탈퇴','quit01','010-1111-8888','quituser@gmail.com','M','1978-05-14',DEFAULT,NULL,NULL,'Y');
