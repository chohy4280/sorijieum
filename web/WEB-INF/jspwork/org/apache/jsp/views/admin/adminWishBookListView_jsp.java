 ...
 * Generated at: 2019-10-11 08:27:14 UTC
...
public final class adminWishBookListView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/../inc/adminTemplate.jsp", Long.valueOf(1570779297071L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	ArrayList<Wishbook> list = (ArrayList<WishBook>)request.getAttribute("list");
      ...
      out.write("\r\n");
      out.write("\t<!--신청도서 목록 시작-->\r\n");
      out.write("\t\t<i class=\"big book icon\"></i><span style=\"font:black; font-size:17pt; padding:10px;\">도서신청내역</span>\r\n");
      out.write("        <br><br>\r\n");
      out.write("        \r\n");
      out.write("        <!-- 검색창 시작!-->\r\n");
      out.write("            <div class=\"greyBox\" style=\"height: 200px;\">\r\n");
      out.write("            <form action=\"\" method=\"post\">\r\n");
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t<a class=\"ui large teal label\">상세검색</a>&nbsp;\r\n");
      out.write("\t\t\t\t\t<select class=\"search\" name=\"searchtype\" id=\"searchtype\" style=\"border-radius: 10px; width: 150px;\">\r\n");
      out.write("\t\t\t\t\t\t<option value=\"bookname\">도서명</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"username\">신청자명</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"userid\">신청자ID</option>\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      ...
      out.write("\t\t\t\t\t<br><br>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<a class=\"ui large teal label\">처리상태</a>&nbsp;\r\n");
      out.write("\t\t\t\t\t<input type=\"radio\" name=\"bookstate\" value=\"all\" checked> 전체 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t<input type=\"radio\" name=\"bookstate\" value=\"wait\"> 승인대기&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t<input type=\"radio\" name=\"bookstate\" value=\"done\"> 승인완료 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t<input type=\"radio\" name=\"bookstate\" value=\"rjct\"> 반려\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t<div>총 <span style=\"font-weight: 600; font-size: 13pt; color:#4ecdc4\">1</span> 건</div>\r\n");
      out.write("\t\t\t\t<br>\r\n");
      ...
      out.write("\t\t\t\t\t\t<th width=\"15%\">신청자(ID)</th>\r\n");
      out.write("\t\t\t\t\t\t<th width=\"10%\">처리상태</th>\r\n");
      out.write("\t\t\t\t\t\t<th width=\"15%\">처리일시</th>\r\n");
      out.write("\t\t\t\t\t\t<th width=\"15%\">처리자</th>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t");
 for(int i = list.size()-1; i >= 0 ; i--) {
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( wb.getWishDate() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td><a href=\"/sori/views/admin/adminWishBookDetailView.jsp\">");
      out.print( wb.getWishBookTitle() );
      out.write("</a></td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( wb.getWishWriter() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( wb.getWishStatus() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
if(wb.getWishStatusDate() == null) {
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t&nbsp;\t<!-- 처리가 아직 진행되지 않아 처리일이 null이면 공백표시 -->\r\n");
      out.write("\t\t\t\t\t\t");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t");
      out.print( wb.getWishStatusDate() );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t");
 } 
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
if(wb.getWishbookAdmin() == null) {
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t&nbsp;\t<!-- 처리가 아직 진행되지 않아 처리자가 null이면 공백표시 -->\r\n");
      out.write("\t\t\t\t\t\t");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t");
      out.print( wb.getWishbookAdmin() );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t");
 } 
      out.write("\r\n");
