...
<div class= "yu-booktitle" style="width: 250px; height:40px; " onclick="location.href='/sori/bsdetail?bookcode=<%=list.get(i).getBookCode()%>&page=<%=currentPage%>'"><%=list.get(i).getBookTitle()%></div>
<% }else{ %>
