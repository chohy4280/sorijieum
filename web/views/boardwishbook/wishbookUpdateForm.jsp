...
<!-- Content 시작! -->
	...
	<form action="/sori/wbup" method="post">
		<table class="my-listTable4" style="width:52%;">
			<tr>
				<th width="20%">제목</th>
				<td width="80%"><div class="ui input"><input type="text" name="wishbooktitle" placeholder="도서명 입력" value="<%= wb.getWishBookTitle() %>" required  style="width:450px;text-align:center;font-family:'S-Core Dream 5';"></div></td>
			</tr>
			<tr>
				<th>저자</th>
				<td width="80%"><div class="ui input"><input type="text" name="wishbookauthor" placeholder="저자명 입력" value="<%= wb.getWishBookAuthor() %>" required style="width:450px;text-align:center;font-family:'S-Core Dream 5';"></div></td>
			</tr>
			<tr>
				<th>출판사</th>
				<% if(wb.getWishPublisher() != null){ %>
				<td width="80%"><div class="ui input"><input type="text" name="wishpublisher" placeholder="출판사 입력" value="<%= wb.getWishPublisher() %>" style="width:450px;text-align:center;font-family:'S-Core Dream 5';"></div></td>
				<% }else{ %>
				<td width="80%"><div class="ui input"><input type="text" name="wishpublisher" placeholder="출판사 입력" value="" style="width:450px;text-align:center;font-family:'S-Core Dream 5';"></div></td>
				<% } %>
			</tr>
			<tr>
				<th>출판일</th>
