...
<body>
	...
	<div class="ye-bookstatus">
		...
		<div class="ye-book">
			...
			<button class="mini ui right labeled icon button" id="mbutton" style="font-family:'S-Core Dream 6'">
  				<i class="angle right icon"></i>더보기
				</button>
			<br><br>
			<div class="ye-bm">
			<a href="/sori/views/bookmaking/bookmakingmain.jsp">
